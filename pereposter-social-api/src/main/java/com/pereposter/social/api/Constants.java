...
public interface Constants {
    ...
    String SOCIAL_GOOGLEPLUS_POST_WRITE_REQUEST_QUEUE = "jms://queue:social.googleplus.post.write.request.queue";
    String SOCIAL_GOOGLEPLUS_POST_WRITE_RESPONSE_QUEUE = "jms://queue:social.googleplus.post.write.response.queue";

    String SOCIAL_GOOGLEPLUS_POST_LIST_WRITE_REQUEST_QUEUE = "jms://queue:social.googleplus.post.list.write.request.queue";
    String SOCIAL_GOOGLEPLUS_POST_LIST_WRITE_RESPONSE_QUEUE = "jms://queue:social.googleplus.post.list.write.response.queue";

    String SOCIAL_GOOGLEPLUS_POST_FIND_BY_ID_REQUEST_QUEUE = "jms://queue:social.googleplus.post.findById.request.queue";
    String SOCIAL_GOOGLEPLUS_POST_FIND_BY_ID_RESPONSE_QUEUE = "jms://queue:social.googleplus.post.findById.response.queue";

    String SOCIAL_GOOGLEPLUS_POST_FIND_BY_OVER_CREATE_DATE_REQUEST_QUEUE = "jms://queue:social.googleplus.post.findByOverCreateDate.request.queue";
    String SOCIAL_GOOGLEPLUS_POST_FIND_BY_OVER_CREATE_DATE_RESPONSE_QUEUE = "jms://queue:social.googleplus.post.findByOverCreateDate.response.queue";

    String SOCIAL_GOOGLEPLUS_POST_FIND_LAST_POST_REQUEST_QUEUE = "jms://queue:social.googleplus.post.findLastPost.request.queue";
    String SOCIAL_GOOGLEPLUS_POST_FIND_LAST_POST_RESPONSE_QUEUE = "jms://queue:social.googleplus.post.findLastPost.response.queue";
